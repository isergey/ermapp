...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.database'
        db.add_column('erm_resource', 'database', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['erm.DataBase']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Resource.database'
        db.delete_column('erm_resource', 'database_id')
