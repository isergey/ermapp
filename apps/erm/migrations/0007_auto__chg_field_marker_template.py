...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Marker.template'
        db.alter_column('erm_marker', 'template_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['erm.Template'], unique=True))

    def backwards(self, orm):
        
        # Changing field 'Marker.template'
        db.alter_column('erm_marker', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['erm.Template'], unique=True))
